...
'''
Class: Persona Parametrisada
Objetivo: Usar parametros en metrodos y constructor para sobrecargar
Fecha: 05/09/2024
'''
class Persona_parametrizada:
    ...
    def caminar(self.distancia-None, lugar-"ciudad"):
        ...
        if peso:
            ...
            self.peso = 0
    def __str__(self):
        return f'Persona_parametrizada(nombre: {self.nombre}, peso: {self.peso})'.format(self.nombre, self.peso)